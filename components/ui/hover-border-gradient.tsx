...
>) {
  ...
  const rotateDirection = (currentDirection: Direction): Direction => {
      ...
      // ensure a Direction is always returned (avoid undefined)
      return (directions[nextIndex] ?? directions[0]) as Direction;
    };
...
const highlight = "radial-gradient(35% 181.15942028985506% at 50% 50%, #000000 0%, rgba(255, 255, 255, 0) 100%)";
