      ...
      <div className="w-full px-6 justify-center items-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="">123 Tech Street</li>
              <li className="">Silicon Valley, CA 94025</li>
              <li><a href="mailto:contact@company.com" className="  transition-colors">contact@company.com</a></li>
              <li><a href="tel:+1234567890" className="  transition-colors">+1 (234) 567-890</a></li>
            </ul>
          </div>
        </div>
